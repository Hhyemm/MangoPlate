...
class RegionSelectContainerViewController: UIViewController {
    ...
    var regionList = [["전체", "한남동", "개포동", "구로구", "금천구", "논현동", "대치동", "도곡동", "방이동", "삼성동", "양재동", "청담동"],["전체", "낙원동", "소격동", "낙원동", "서교동", "서대문구", "성북구", "연남동", "은평구", "중구", "중랑구"], ["전체", "고양시", "가평군", "과천시", "광명시", "광주시", "구리시", "군포시", "김포시", "남양주시", "동두천시", "부천시", "성남시", "수원시", "시흥시", "안산시"],["전체", "인천 강화군", "인천 계양구", "인천 남동구", "인천 동구", "인천 미주홀구", "인천 부평구", "인천 서구", "인천 연수구", "인천 옹진군", "인천 중구"],["전체", "대구 남구", "대구 달서구", "대구 달성군", "대구 동구", "대구 북구", "대구 서구", "대구 수성구"],["전체", "부산 강서구", "부산 금정구", "부산 기장군", "부산 남구"],["전체"]]
    ...
    @IBAction func pressApplyButton(_ sender: UIButton) {
        if nowView == "search" || nowView == "map" {
            ...
            if pressedRegionCount > 0 {
                ...
                VC.regionTitle = pressedRegion.sorted(by: <)
